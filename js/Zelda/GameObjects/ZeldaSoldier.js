class ZeldaSoldier extends GameObject {
    ...
    init() {
        ...
        this.transform.position = new Vector2(Math.random() * (this.boundarySize.x - this.transform.size.x), Math.random() * (this.boundarySize.y - this.transform.size.y));
...
//# sourceMappingURL=ZeldaSoldier.js.map