...
var TileCloudTop = /** @class */ (function (_super) {
    __extends(TileCloudTop, _super);
    function TileCloudTop() {
                    ...
                    "idle": new dist_1.SpritesheetAnimation({
                        ...
                        transforms: [
                            new dist_1.Transform({
                                position: new dist_1.Vector2(_1.Tile.spriteSize.x * 1, _1.Tile.spriteSize.y * 20),
...
exports.TileCloudTop = TileCloudTop;
//# sourceMappingURL=TileCloudTop.js.map